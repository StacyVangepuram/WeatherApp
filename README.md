...
- **Premium Glassmorphism UI**: Utilizes modern web design trends like `backdrop-filter`, semi-transparent cards, and clean typography for a high-end feel.
...
- **JavaScript (ES6+)**: Async/Await data fetching and DOM manipulation.
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/StacyVangepuram/WeatherApp.git
   ```
